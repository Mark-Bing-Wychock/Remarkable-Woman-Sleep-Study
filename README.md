...
19. `Did I Wake Up?` - Binary (Yes/No) measure of whether	a wakeup occurred in the middle of a sleep cycle (between Bed Time and Rise Time).  Only counted once if there are multiple wakeups.
